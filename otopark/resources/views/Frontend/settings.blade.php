        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div align="right"><a href="{{route('full')}}"><button class="btn btn-dark">Back</button></a></div>
                            <h4 class="card-title">Empty The Park</h4>
                            @foreach($empty as $key)
                            <form class="forms-sample" action="{{route('settingspost',['id'=>$key->block_id])}}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" name="date2" value="{{$key->date2}}">
                                </div>
